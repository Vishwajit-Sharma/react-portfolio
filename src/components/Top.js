        ...
        <div className="row">
            <div className="col-md-6 col-12">
                <div className="top-left">
                    ...
                    <p className='d-flex my-lg-5 my-md-4 my-4 justify-content-around'><a href="#"><button className="btn1">Hire Me</button></a> <a href="#"><button className="btn2">Get Resume</button></a></p>
                </div>
            </div>
            <div className="col-md-6 col-12">
